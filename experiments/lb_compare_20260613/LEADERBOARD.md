...
- **Verdict (LM bpb): the Emender variants TIE the GDN-2 / m2rnn baselines. No win.**
  ...
  tasks (emender-real-1p3b NULL at scale, emender-cap-sweep NULL, opt-1p3b null, lb-emender-mix
  near-pure-E97).
...
bpb (non-avg), best LM bpb (avg), and decisive winner on modular_counter. The Emender ties
LM held-out bpb and loses the modular_counter separator to GDN-2 at 1.3B.
