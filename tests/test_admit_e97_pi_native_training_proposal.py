from scripts.admit_e97_pi_native_training_proposal import PROPOSAL_SHA,STATEMENT,affine
...
def test_admission_affine_matches_runtime_planner_contract():
 ...
 assert len(PROPOSAL_SHA)==64 and STATEMENT=='I authorize the exact 32 update proposal.'
