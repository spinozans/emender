...
"$PY" "$REPO/scripts/prepare_e97_pi_native_repair_training.py" \
 --translated-oh-source "$T/e97-oh-pi-native-translation-v1/candidate-authority" \
 --translated-oh-sha a179c140b4e8efa77a8163574bb78d4fe34dea91adfeb0439e8339d5002be1fb \
 --translated-oh-budget-targets 26000000 --translated-oh-seed 920001 \
 ...
 --conversation-budget-targets 60000000 --conversation-seed 613117 \
 ...
 --output "$T/pi-native-repair9-full-preparation-v3"
