...
def audit(a):
 ...
 if (valid,correct,successes)!=(summary['valid_first_frames'],summary['correct_first_actions'],summary['successes']) or summary['gate']['passed'] or (valid>=12 and correct>=10) or summary['automatic_retries'] or summary['optimizer_updates'] or summary['checkpoint_promotion']:raise ValueError('negative gate accounting')
