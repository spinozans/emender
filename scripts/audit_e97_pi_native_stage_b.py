...
def audit(a):
 ...
 if sha(a.plan)!=summary['plan_sha256'] or sha(plan['panel'])!=plan['panel_sha256'] or sha(plan['checkpoint'])!=plan['checkpoint_sha256'] or terminal!={'original_exit':0,'audited_exit':0,'automatic_retries':0,'optimizer_updates':0}:raise ValueError('authority/terminal')
