#!/usr/bin/env python3
"""Protected-panel entity-overlap audit for the hybrid-conversation pilot collection."""
...
def audit(args):
 ...
 finish_values={s['arguments']['message'] for c in cases for s in c['steps'] if s.get('name')=='finish' and 'arguments' in s}
 ...
 receipt={'schema':'emender-e97-hybrid-conversation-overlap-audit-v1','status':'pass','records':len(ids),
