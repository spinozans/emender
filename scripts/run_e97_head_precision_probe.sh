...
CUDA_VISIBLE_DEVICES='' "$PYTHON_BIN" -m pytest -q tests/test_e97_head_precision_probe.py tests/test_e97_outcome_rl_candidate.py tests/test_e97_native_onpolicy_canary.py tests/test_e97_native_execution.py
CUDA_VISIBLE_DEVICES='' "$PYTHON_BIN" scripts/qualify_e97_native_rl_logprobs.py freeze --head-probe --output "$RUN"
